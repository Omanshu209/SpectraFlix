...
public class MainActivity extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		Movie mov2 = new Movie("Zootopia", "", "", R.drawable.zootopia, R.drawable.zootopia_title, "", "1LUvPO6INLgLZg2EegeKuTDXKe5uKp2ct", "", 0, "When Judy Hopps, a rookie officer in the Zootopia Police Department, sniffs out a sinister plot, she enlists the help of a con artist to solve the case in order to prove her abilities to Chief Bogo.", new int[19]);
		...
		Movie mov4 = new Movie("Frozen II", "", "", R.drawable.frozen_2, R.drawable.frozen_2_title, "", "1FilPpbqmjmbtYBu_1k7QJ-1G1tQZGzLN", "", 0, "Three years after her coronation when Elsa celebrates Autumn, she hears a mysterious voice. She follows that voice along with Anna and their friends as they are forced to uncover the truth.", new int[19]);
		...
		Movie mov10 = new Movie("The Conjuring 2", "", "", R.drawable.the_conjuring_2, R.drawable.the_conjuring_2_title, "", "1B6OqDkR45Z2MmPkCoRvKEkg6b5Ol7DWv", "", 0, "Peggy, a single mother of four children, seeks the help of occult investigators Ed and Lorraine Warren when she and her children witness strange, paranormal events in their house.", new int[19]);
