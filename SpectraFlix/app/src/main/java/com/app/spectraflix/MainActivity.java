...
public class MainActivity extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		Movie mov1 = new Movie("Moana", "", "", R.drawable.moana, R.drawable.moana_title, "", "", "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4", "", 0, "Moana, daughter of chief Tui, embarks on a journey to return the heart of goddess Te Fitti from Maui, a demigod, after the plants and the fish on her island start dying due to a blight.", new int[19]);
		...
		Movie mov3 = new Movie("Toy Story 3", "", "", R.drawable.toy_story_3, R.drawable.toy_story_3_title, "", "", "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4", "", 0, "Before Andy leaves for college, his toys are mistakenly delivered to a day care centre. Woody convinces the other toys that they were not dumped and leads them on an expedition back home.", new int[19]);
		...
		Movie mov5 = new Movie("Oppenheimer", "", "", R.drawable.oppenheimer, R.drawable.oppenheimer_title, "", "", "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4", "", 0, "During World War II, Lt. Gen. Leslie Groves Jr. appoints physicist J. Robert Oppenheimer to work on the top-secret Manhattan Project. Oppenheimer and a team of scientists spend years developing and designing the atomic bomb. Their work comes to fruition on July 16, 1945, as they witness the world's first nuclear explosion, forever changing the course of history.", new int[19]);
		Movie mov6 = new Movie("Free Guy", "", "", R.drawable.free_guy, R.drawable.free_guy_title, "", "", "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4", "", 0, "Guy lives a seemingly peaceful life as a bank teller. However, an encounter with a pretty but mysterious woman makes him realise that he is a non-playable character in a massive online video game.", new int[19]);
		Movie mov7 = new Movie("Kill", "", "", R.drawable.kill, R.drawable.kill_title, "", "", "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4", "", 0, "A train to New Delhi becomes a combat battleground as a pair of commandos faces off against an army of invading bandits.", new int[19]);
		...
		Movie mov9 = new Movie("The Conjuring", "", "", R.drawable.the_conjuring, R.drawable.the_conjuring_title, "", "", "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4", "", 0, "Rod and Carolyn find their pet dog dead under mysterious circumstances and experience a spirit that harms their daughter Andrea. They finally call investigators who can help them get out of the mess.", new int[19]);
		...
		Movie mov11 = new Movie("Annabelle Creation", "", "", R.drawable.annabelle_creation, R.drawable.annabelle_creation_title, "", "", "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4", "", 0, "A doll-maker and his wife embed the spirit of their deceased daughter inside a doll. Years later, a nun and several girls from a shuttered orphanage become victims of the possessed doll, Anabelle.", new int[19]);
		...
		Movie mov13 = new Movie("Interstellar", "", "", R.drawable.interstellar, R.drawable.interstellar_title, "", "", "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4", "", 0, "When Earth becomes uninhabitable in the future, a farmer and ex-NASA pilot, Joseph Cooper, is tasked to pilot a spacecraft, along with a team of researchers, to find a new planet for humans.", new int[19]);
