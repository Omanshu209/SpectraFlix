...
public class removeBookableMovie extends Activity
{
	@Override
	protected void onCreate(Bundle savedInstanceState)
	{
		super.onCreate(savedInstanceState);
		setContentView(R.layout.remove_bookable_movie);
		...
		TextView removeTextView = findViewById(R.id.remove_bookable_movie);
		...
		removeButton.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				else
				{
					...
					dataManager.removeBookableMovie(title);
